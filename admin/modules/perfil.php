                    ...
                    <div class="body">
                        <div class="d-flex bd-highlight mb-4">
                            <div class="flex-fill bd-highlight">
                                <h5 class="mb-0">
                                    21,521 <i class="fa fa-angle-up"></i>
                                </h5>
                                <small>Today</small>
                            </div>
                            <div class="flex-fill bd-highlight">
                                <h5 class="mb-0">
                                    %12.35 <i class="fa fa-angle-down"></i>
                                </h5>
                ...
                <div class="card">
                    ...
                    <div class="body">
                        <div class="d-flex bd-highlight mb-4">
                            ...
                            <div class="flex-fill bd-highlight">
                                <h5 class="mb-0">
                                    18.35 <i class="fa fa-angle-down"></i>
                                </h5>
                                <small>Last month %</small>
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="body todo_list">
                        <div class="form-group d-flex mb-1">
                            ...
                            <button class="btn btn-primary ml-2" type="button" id="button-addon2">
                                Add
                            </button>
                        </div>
                        <ul class="list-group">
                ...
                <div class="card">
                    ...
                    <div class="body">
                        <ul class="list-unstyled list-referrals">
                            <li>
                                <p>
                                    <span class="value">2301</span><span class="text-muted float-right">visits from
                                        Facebook</span>
                                </p>
                            ...
                            <li>
                                <p>
                                    <span class="value">2107</span><span class="text-muted float-right">visits from
                                        Twitter</span>
                                </p>
                                <div class="progress progress-xs">
                            ...
                            <li>
                                <p>
                                    <span class="value">2308</span><span class="text-muted float-right">visits from
                                        Search</span>
                                </p>
                                <div class="progress progress-xs">
                            ...
                            <li>
                                <p>
                                    <span class="value">1024</span><span class="text-muted float-right">visits from
                                        Affiliates</span>
                                </p>
                                <div class="progress progress-xs">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="align-right">
                                        <span class="badge badge-lg badge-pill badge-success text-uppercase">40%</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Mozila Firefox</td>
                                    <td class="align-right">
                                        <span class="badge badge-lg badge-pill badge-primary text-uppercase">30%</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Safari</td>
                                    <td class="align-right">
                                        <span class="badge badge-lg badge-pill badge-tertiary text-uppercase">15%</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Internet Explorer</td>
                                    <td class="align-right">
                                        <span class="badge badge-lg badge-pill badge-primary text-uppercase">15%</span>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <div class="d-flex align-items-start">
                            ...
                            <div class="icon-text">
                                <h4 class="heading text-white">
                                    Latest Bootstrap framework <small>(v4.3.1)</small>
                                </h4>
                                <p class="text-white">
                ...
                <div class="card bg-dark">
                    <div class="card-body py-5">
                        <div class="d-flex align-items-start">
                            ...
                            <div class="icon-text">
                                <h4 class="heading text-white">
                                    Latest JQuery framework <small>(v3.3.1)</small>
                                </h4>
                                <p class="text-white">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                                    sed do eiusmod tempor incididunt ut labore et dolore
